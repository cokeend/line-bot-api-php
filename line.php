  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "ยอด")||($text == "อุณหภูมิ")){
			$temp = 27;
			$reply_message = '"รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย" <br> ผู้ป่วยสะสม    จำนวน 398,995 ราย <br> ผู้เสียชีวิต    จำนวน 17,365 ราย <br> รักษาหาย    จำนวน 103,753 ราย <br> ผู้รายงานข้อมูล: นายพิทวัส ทัศนัย';
		}
